...
<head>
    ...
    <title>EZ PARK-Signup Page</title>
    <style>
        #sign {
                ...
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: black; background-color: white; padding:20px; margin:0px;"><i
                                class="fa-solid fa-user"></i>&emsp;<strong>EZ-PARK CREATE ACCOUNT</strong>
                        </h2>
                    </a>
                </div>
                ...
                <div class="login-form">
                    <form method="post" onsubmit="return checkpass();">
                        ...
                        <button type="submit" name="submit" id="sign"
                            class="btn btn-success btn-flat m-b-30 m-t-30">REGISTER</button>
