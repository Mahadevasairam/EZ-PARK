                ...
                <div class="login-logo">
                    <a href="login.php">
                        <h2 style="color: black; background-color: white; padding:20px; margin:0px;"><i
                                class="fa-solid fa-user"></i>&emsp;<strong>EZ-PARK USER</strong>
                        </h2>
                    </a>
                </div>
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="emailcont" required="true"
                                placeholder="Registered Email or Contact Number" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="login" id="sign-in"
                            class="btn btn-success btn-flat m-b-30 m-t-30">Sign
                            in</button>
